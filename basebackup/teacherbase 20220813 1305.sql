...
CREATE TABLE `accounts` (
  ...
  `confiirm` int unsigned NOT NULL DEFAULT '0' COMMENT 'Профиль подтвержден учителем',
  PRIMARY KEY (`id`),
...
INSERT INTO `accounts` (`id`,`role`,`login`,`password`,`surname`,`name`,`secname`,`class`,`confiirm`) VALUES 
